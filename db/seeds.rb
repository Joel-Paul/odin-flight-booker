...
Flight.create!([
  ...
  },
  {
    ...
    takeoff: DateTime.current.advance(days: -1),
    landing: DateTime.current.advance(days: -1, hours: 1, minutes: 20)
  },
  {
    departure_airport: Airport.find_by(IATA: "OOL"),
    arrival_airport: Airport.find_by(IATA: "DRW"),
    takeoff: DateTime.current.advance(days: 3),
    landing: DateTime.current.advance(days: 3, hours: 8)
  },
  {
    departure_airport: Airport.find_by(IATA: "DRW"),
    arrival_airport: Airport.find_by(IATA: "MEL"),
    takeoff: DateTime.current.advance(days: 4),
    landing: DateTime.current.advance(days: 4, hours: 4)
  },
  {
    departure_airport: Airport.find_by(IATA: "MEL"),
    arrival_airport: Airport.find_by(IATA: "HBA"),
    takeoff: DateTime.current.advance(days: 2),
    landing: DateTime.current.advance(days: 2, hours: 1, minutes: 20)
  },
  {
    departure_airport: Airport.find_by(IATA: "HBA"),
    arrival_airport: Airport.find_by(IATA: "MCY"),
    takeoff: DateTime.current.advance(days: 63),
    landing: DateTime.current.advance(days: 63, hours: 3)
  },
  {
    departure_airport: Airport.find_by(IATA: "MCY"),
    arrival_airport: Airport.find_by(IATA: "BNE"),
    takeoff: DateTime.current.advance(days: 3),
    landing: DateTime.current.advance(days: 3, hours: 3)
  },
  {
    departure_airport: Airport.find_by(IATA: "BNE"),
    arrival_airport: Airport.find_by(IATA: "BME"),
    takeoff: DateTime.current.advance(days: 53),
    landing: DateTime.current.advance(days: 53, hours: 8)
  },
  {
    departure_airport: Airport.find_by(IATA: "BME"),
    arrival_airport: Airport.find_by(IATA: "CNS"),
    takeoff: DateTime.current.advance(days: 34),
    landing: DateTime.current.advance(days: 34, hours: 10)
  },
  {
    departure_airport: Airport.find_by(IATA: "CNS"),
    arrival_airport: Airport.find_by(IATA: "CBR"),
    takeoff: DateTime.current.advance(days: 12),
    landing: DateTime.current.advance(days: 12, hours: 4)
  },
  {
    departure_airport: Airport.find_by(IATA: "CBR"),
    arrival_airport: Airport.find_by(IATA: "HID"),
    takeoff: DateTime.current.advance(days: 21),
    landing: DateTime.current.advance(days: 21, hours: 6)
  },
  {
    departure_airport: Airport.find_by(IATA: "HID"),
    arrival_airport: Airport.find_by(IATA: "NTL"),
    takeoff: DateTime.current.advance(days: 23),
    landing: DateTime.current.advance(days: 23, hours: 7)
  },
  {
    departure_airport: Airport.find_by(IATA: "NTL"),
    arrival_airport: Airport.find_by(IATA: "PER"),
    takeoff: DateTime.current.advance(days: 2),
    landing: DateTime.current.advance(days: 2, hours: 6)
  },
  {
    departure_airport: Airport.find_by(IATA: "PER"),
    arrival_airport: Airport.find_by(IATA: "ADL"),
    takeoff: DateTime.current.advance(days: 5),
    landing: DateTime.current.advance(days: 5, hours: 3)
  }
])
